...
- 本專案最終本機引擎提交：`f6e20a6d788c113b2ed1f42ad7f849ff20f49d98`
- 套用後預期 Git tree：`3c77daf2266c1921307206715075e7a017c7d08a`
- 補丁 SHA-256：`11576f17ccad8c72fe43c423cff65f5ebcfc4ca9c0a69524088c83afb7ef6852`
...
`commits.txt` 依時間順序記錄這段範圍的 123 個本機提交，方便回查每項修改的目的。合併補丁本身不會在目標 clone 重建這 123 筆提交歷史，只會重建相同的最終檔案內容。
...
```text
3c77daf2266c1921307206715075e7a017c7d08a
```
