...
**最後更新：** 2026-09-02（本輪遊戲體驗改造均已由使用者實機驗收：**按住 Tab 顯示可互動熱區**、**法術分類顯示已學數量／空分類顯示「尚未學習」**、**10 槽輪替自動存檔**、**地圖顯示已發現洞穴入口記號**、**俯瞰地圖支援 WASDQE 與 T 紮營**。洞穴地標已再擴充 zone 2／6，完成重編與離線驗證，待實機驗收。完整紀錄見 [`docs/research/ux-improvements-2026-09-02.md`](docs/research/ux-improvements-2026-09-02.md)。）
...
- **洞穴地標擴充至全部三個戶外入口，待實機驗收**（2026-09-02）：RMF 掃描確認戶外 `entrance` shape 50 僅出現在 zone 1／2／6；沿用 zone 1 已驗收的入口立面校準，依模型旋轉推導 zone 2／6 標記座標，事件編號為 2／3。引擎提交 `d702c75`；Borland 3.1 重編完成，`KRONDOR.EXE` **466944 bytes**、SHA-256 `a0419e822d7a005273bd57ff641420b7545acf46de7bf028d987409993a0feb9`，兩個 OVL byte-identical；100 項測試通過，差分補丁與整合包已重建。驗收前不更新 `engine-patches/` 封存基準。詳見 [`docs/research/ux-improvements-2026-09-02.md`](docs/research/ux-improvements-2026-09-02.md)。
