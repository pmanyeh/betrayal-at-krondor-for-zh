...
**最後更新：** 2026-09-01（**WASDQE 移動後「循路前進」按鈕不刷新已修正並通過實機驗收**；**互動式角色法術瀏覽器已定版並通過實機驗收**：六學派頁籤＋逐項法術清單＋完整大字說明；**兩套密技中心已中文化，寶箱選單可啟動進階密技熱鍵**；**角色狀態名稱已全中文化**；**物品數量選擇框已全中文化並改小字**；**神殿治療報價文案被裁切已修正**；**行走操控：A/D 轉向、Q/E 平移、T 紮營**；先前：發布用「免安裝整合包」工具鏈）
